...
class _AlertasPageState extends State<AlertasPage> {
  final List<Alerta> meusAlertas = AlertasService.alertas;
                    ...
                    children: [
                      ...
                      ElevatedButton(
                        ...
                        onPressed: () async {
                          ...
                          if (novo != null) {
                            setState(() {
                              AlertasService.adicionarAlertaObj(novo);
                            });
                          }
                        },
                        child: const Text(
                                  ...
                                  trailing: Row(
                                    ...
                                    children: [
                                      ...
                                      IconButton(
                                        ...
                                        onPressed: () {
                                          setState(() {
                                            AlertasService.removerAlerta(index);
                                          });
                                        },
                                      ),
                                    ],
